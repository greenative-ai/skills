...
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"storage","action":"..."}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"storage","action":"putref","datasource":"ds1","object":"data.csv"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"storage","action":"getref","datasource":"ds1","object":"data.csv"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"storage","action":"list","datasource":"ds1"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"storage","action":"delete","datasource":"ds1","object":"file1.txt"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
