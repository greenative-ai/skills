...
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"function","action":"..."}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"function","action":"request","name":"myfunc"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"function","action":"request","name":"linetest","datasource":"ds1","object":"data1.csv"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"function","action":"terminate","id":"Kxf9K3L9T83Ke0pwMIOn"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"function","action":"list","status":"success"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
...
```bash
curl -s -X POST -H 'content-type: application/json' \
  -d "$(printf '{"accesskey":"%s","secret":"%s","component":"function","action":"list"}' "$GN_KEY" "$GN_SECRET" | base64)" \
  "$GN_ENDPOINT"
```
